      ...
      <div className="pt-16">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col items-center mb-4 mt-8 space-y-4">
              <img src="/envio.jpg" alt="Envíos a todo el país" className="w-64 h-auto rounded" />
              <img src="/logo-wompi.svg" alt="Logo Wompi" className="w-20 h-20" />
            </div>
          </div>
        </section>
