...
export function ConfirmacionTransferencia() {
    ...
    useEffect(() => {
        ...
        const fetchTransactionStatus = async () => {
            if (id) {
                try {
                    const response = await fetch(`${process.env.REACT_APP_WOMPI_URL}${id}`, {
                        method: 'GET',
                    });
                    ...
                    switch (result.data.status) {
                        case 'APPROVED':
                            ...
                            try {
                                await fetch(`${process.env.REACT_APP_BASE_URL}/compras/${idc}/transferencia-id`, {
                                    method: 'PATCH',
                                    headers: {
